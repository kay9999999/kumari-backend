...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    filters: Schema.Attribute.Relation<'manyToMany', 'api::filter.filter'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFilterValueFilterValue extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filter: Schema.Attribute.Relation<'manyToOne', 'api::filter.filter'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::filter-value.filter-value'
...
export interface ApiFilterFilter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filter_group: Schema.Attribute.String;
    filter_values: Schema.Attribute.Relation<
      'oneToMany',
      'api::filter-value.filter-value'
    >;
    ...
    sub_categories: Schema.Attribute.Relation<
      ...
      'api::sub-category.sub-category'
    >;
    type: Schema.Attribute.Enumeration<['filter', 'option', 'both']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bg_mid: Schema.Attribute.Media<'images'>;
    carousel: Schema.Attribute.Component<'layout.hero-2', false>;
    categories: Schema.Attribute.Component<'layout.categories', false>;
    categories_hover: Schema.Attribute.Component<
      'layout.categories-hover',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    guide: Schema.Attribute.Component<'layout.guide', true>;
    hero: Schema.Attribute.Media<'images' | 'videos', true>;
    hero_2: Schema.Attribute.Media<'images'>;
    home_product: Schema.Attribute.Component<'layout.home-product', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    policy: Schema.Attribute.Component<'layout.policy', false>;
    publishedAt: Schema.Attribute.DateTime;
